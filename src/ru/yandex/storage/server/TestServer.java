...
import ru.yandex.storage.coordinator.Coordinator;
import ru.yandex.storage.coordinator.TestFailedException;
...
//        UnicastRemoteObject.exportObject(server1, 1234);
//        UnicastRemoteObject.exportObject(server2, 1235);
